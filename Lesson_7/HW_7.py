...
class Truck(Vehicle):
    ...
    def ride(self):
        ...
        print('{} выехал в путь, осталось {}'.format(self.model, self.distance_to_target))
...
class AutoLoader(Vehicle):
    ...
    def load(self):
        truc_cargo_rest = self.truck.body_space - self.truck.cargo
...
loader_2 = AutoLoader(model='Lonking', bucket_capacity=500, warehouse=moscow, role='unloader')
